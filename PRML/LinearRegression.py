...
if __name__ == "__main__":
    task_map = {
        "0": "LinearRegressionGD",
        "1": "RegressionPrediction",
    }

    print("请选择要运行的任务：")
    print("  0 - LinearRegressionGD (data/ex1data1.txt)")
    print("  1 - RegressionPrediction (data/boston.csv)")

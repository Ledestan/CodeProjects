...
class Window:
    def __init__(self):
        ...
        tk.Button(
            ...
            height=2,
            font=("SimSun", 14),
            command=lambda: self.list_count_to_dict(0, 1),
        ...
        tk.Button(
            ...
            height=2,
            font=("SimSun", 14),
            command=lambda: self.list_count_to_dict(1, 4),
        ...
        tk.Button(
            ...
            height=2,
            font=("SimSun", 14),
            command=lambda: self.list_count_to_dict(4, 6),
        ...
        tk.Button(
            ...
            height=2,
            font=("SimSun", 14),
            command=lambda: self.list_count_to_dict(6, 7),
    ...
    def draw_pie_chart(self, data_dict):
        ...
        if self.pie_window and self.pie_window.winfo_exists():
            ...
            self.pie_window.canvas = tk.Canvas(
                self.pie_window, width=1000, height=700, bg="white"
            )
        ...
        for i, (label, value) in enumerate(data_dict.items()):
            ...
            self.pie_window.canvas.create_polygon(
            ...
            self.pie_window.canvas.create_text(
                text_x,
                text_y,
        ...
        for i, (label, value) in enumerate(data_dict.items()):
            percentage = (value / total) * 100
            color = colors[i % len(colors)]
            self.pie_window.canvas.create_rectangle(
                legend_x,
                legend_y + i * 40,
                legend_x + 20,
                legend_y + 20 + i * 40,
